Public Class form1Pad
    ...
    Private Sub Timer1_Tick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Timer1.Tick
        ...
        ' Label6.Text = "0"
        'End If
        If cvtaskbar.BackColor = Color.DarkRed Then
        ...
        If Label3.Text = "fredag:13" Then
            ...
            cvtaskbar.BackColor = Color.DarkRed
        Else
        End If
        If cvtaskbar.BackColor = Color.DarkBlue Then
        Else
            If cvtaskbar.BackColor = Color.Pink Then
            Else
                If cvtaskbar.BackColor = Color.Blue Then
                Else
                    If cvtaskbar.BackColor = Color.Red Then
                    Else
                        If cvtaskbar.BackColor = Color.DarkGray Then
                        Else
                            If cvtaskbar.BackColor = Color.Gray Then
                            Else
                                If cvtaskbar.BackColor = Color.Silver Then
                                Else
                                    If cvtaskbar.BackColor = Color.DarkRed Then
                                    Else
                                        'cvtaskbar.BackColor = Color.Silver
                                    End If
                                End If
                            End If
                        End If
    ...
    Private Sub PictureBox2_MouseEnter(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles PictureBox2.MouseEnter
        ...
        End If
        If PictureBox2.BackColor = Color.WhiteSmoke Then
